            ...
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                <div class="text-center md:text-left">
                    <a href="#" class="flex items-center space-x-3">
                        ...
                        <span class="text-gray-900 text-lg font-semibold">CastWave</span>
                    </a>
                ...
                <div class="flex space-x-6">
                    <a href="https://www.facebook.com/" class="text-gray-900 hover:text-gray-200 transition duration-300">
                    ...
                    <a href="https://github.com/" class="text-gray-900 hover:text-gray-200 transition duration-300">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path
                    ...
                    <a href="https://x.com/" class="text-gray-900 hover:text-gray-200 transition duration-300">
                        <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                            <path
